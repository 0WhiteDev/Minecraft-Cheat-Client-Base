...
import client.whitedev.mods.serverinfo.GuiPinger;
...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public String lastUpdatedServerAdress = "";
    private GuiPinger guiPingElement;
    ...
    public void initGui()
    {
        ...
        this.guiPingElement = new GuiPinger(width / 2 - 150, 40, 325, 50, new ServerData(this.lastUpdatedServerAdress, this.lastUpdatedServerAdress, false), true);
        this.guiPingElement.setServerIP(this.field_146302_g.getText());
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        if (this.field_146302_g.textboxKeyTyped(typedChar, keyCode))
        {
            ((GuiButton)this.buttonList.get(0)).enabled = this.field_146302_g.getText().length() > 0 && this.field_146302_g.getText().split(":").length > 0;
            this.guiPingElement.setServerIP(this.field_146302_g.getText());
            this.guiPingElement.resetAnimation();
        }
