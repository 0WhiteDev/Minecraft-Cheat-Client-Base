...
import client.whitedev.gui.mainmenu.GuiClientMainMenu;
import client.whitedev.gui.hook.GuiClientInGame;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.ingameGUI = new GuiClientInGame(this);
        ...
        try {
            ClientBase.getClient().clientStart();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
