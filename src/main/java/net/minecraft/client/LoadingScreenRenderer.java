            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                if (flag)
                {
                    ...
                    else
                    {
                        ...
                        worldrenderer.pos(0.0D, (double)l, 0.0D).tex(0.0D, (double)((float)l / f)).color(0, 0, 0, 0).endVertex();
                        worldrenderer.pos((double)k, (double)l, 0.0D).tex((double)((float)k / f), (double)((float)l / f)).color(0, 0, 0, 0).endVertex();
                        worldrenderer.pos((double)k, 0.0D, 0.0D).tex((double)((float)k / f), 0.0D).color(0, 0, 0, 0).endVertex();
                        worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 0).endVertex();
                        tessellator.draw();
                    }
