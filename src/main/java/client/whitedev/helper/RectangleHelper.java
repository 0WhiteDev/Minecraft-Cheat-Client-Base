...
public class RectangleHelper {
    ...
    public static void drawRect(double left, double top, double right, double bottom, Color color) {
        ...
        worldrenderer.putPosition(left, bottom, 0.0D);
        worldrenderer.putPosition(right, bottom, 0.0D);
        worldrenderer.putPosition(right, top, 0.0D);
        worldrenderer.putPosition(left, top, 0.0D);
        tessellator.draw();
